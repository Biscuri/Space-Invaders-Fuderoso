...
import controller.HangarKeyListener;
import util.DataBase;
/**
 * Classe responsavel pelo Hangar (Loja) do jogo
...
public class Hangar extends  JDialog {
	...
	private HangarKeyListener evento;
	
	public Hangar(Mundo mundo, DataBase dataBase){
		this.mundo = mundo;
		this.dataBase = dataBase;
		evento = new HangarKeyListener(dataBase);
		mostraHangar();
	}
	/**
         * Metodo  que cria a Loja adicionado seus botoes e funcionalidades.
         */
	private void mostraHangar(){
		...
		loja1.add(new JLabel("Vejo que voce possui um pouco de dinheiro, gostaria de comprar algo?"));
