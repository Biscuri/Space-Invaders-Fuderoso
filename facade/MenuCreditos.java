...
public class MenuCreditos extends JDialog {
	...
	public MenuCreditos(JFrame mestre) {
		...
		painel.add(new JLabel(" A muito, muito tempo, em uma gal�xia muito distante."));
		...
		painel.add(new JLabel(" \" -EU!... Sim, EU!... N�o voc�(eu), EU! EU POHA! \" "));
		painel.add(new JLabel(" OOoooooOoOooo Chapolin Colorado"));
		painel.add(new JLabel(" "));
		painel.add(new JLabel(" \" - N�o contavam com minha ast�cia \" "));
		painel.add(new JLabel(" "));
